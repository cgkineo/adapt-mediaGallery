define([
    ...
    var MediaWithBenefitsView = Media.view.extend({
        ...
        selectItem:function(index) {
            ...
            var $selectedItem = this.$('.mwb-item').eq(index);

            // update classes
            this.$('.mwb-item').removeClass('selected');
        ...
        playSelection:function() {
            var $selectedItem = this.$('.mwb-item').eq(this.selectedIndex);
